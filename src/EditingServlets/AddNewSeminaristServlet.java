...
public class AddNewSeminaristServlet extends HttpServlet {
     ...
     */
    public AddNewSeminaristServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(currentClassroom.classroomAddSeminarist(email)) {
			RequestDispatcher view = request.getRequestDispatcher("edit.jsp?"+EditStatusConstants.STATUS +"="
					+ EditStatusConstants.ADD_NEW_SEMINARIST_ACC);	
						 
			view.forward(request, response);  
			System.out.println("Added Seminarist: " + name + " " + surname + " " + email + " to class with id: " + classroomId);
		}
		else {
			RequestDispatcher view = request.getRequestDispatcher("edit.jsp?"+EditStatusConstants.STATUS +"="

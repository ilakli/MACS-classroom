		...
		<div class="content">
				<div class="field">
					<div class="emails">
						...
						<input type="hidden" id = "studentServlet" value="AddNewStudentServlet">
					</div>
				</div>
		</div>
		<div class="actions">
		...
		<div class="content">
				<div class="field">
					<div class="emails">
						...
						<input type="text" value="" placeholder="Add Email" /> 
						<input type="hidden" id="sectionLeaderAddServlet" value="AddNewSectionLeaderServlet">
					</div>
				</div>
		</div>
		<div class="actions">
		...
		<div class="content">
				<div class="field">
					<div class="emails">
						...
						<input type="text" value="" placeholder="Add Email" /> 
						<input type="hidden" id="seminaristAddServlet" value="AddNewSeminaristServlet">
					</div>
				</div>
		</div>
		<div class="actions">
		...
		<div class="content">
				<div class="field">
					<div class="emails">
						...
						<input type="text" value="" placeholder="Add Email" /> 
						<input type="hidden" id="lecturerAddServlet" value="AddNewLecturerServlet">
					</div>
				</div>
		</div>
		<div class="actions">
